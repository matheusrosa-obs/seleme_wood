...
empresas = empresas[['nm_razao_social', 'nm_nome_fantasia', 'nm_nome_socio', 'nm_porte_obs', 'ano_inicio', 'sg_uf',
...
empresas['nm_nome_fantasia'] = empresas['nm_nome_fantasia'].str.title()
...
empresas = empresas.rename(columns={
    ...
    "nm_nome_fantasia": "Nome Fantasia",
